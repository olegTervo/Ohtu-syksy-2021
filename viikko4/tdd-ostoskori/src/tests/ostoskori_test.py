...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_lisaamisen_jalkeen_korin_hinta_on_sama_kuin_2_kertaa_tuotteen_hinta(self):
        maito = Tuote("Maito", 3)
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korissa_yksii_ostosolio(self):
        maito = Tuote("Maito", 3)
    ...
    def test_poisto_kun_lkm_on_yksi(self):
        maito = Tuote("Maito", 3)
